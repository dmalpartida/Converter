...
public class FuelEntry {
    ...
    public static FuelEntry[] populateData() {
        return new FuelEntry[]{
                new FuelEntry(1, "Seleccionar", 5),
                new FuelEntry(2, "Seleccionar", 32),
                new FuelEntry(3, "Seleccionar", 33),
                new FuelEntry(4, "Seleccionar", 34),
                new FuelEntry(5, "Seleccionar", 35),
                new FuelEntry(6, "Seleccionar", 66),
                new FuelEntry(7, "Seleccionar", 67),
                new FuelEntry(8, "Seleccionar", 68),
                new FuelEntry(9, "Seleccionar", 69),
                new FuelEntry(10, "Seleccionar", 70),
                new FuelEntry(11, "Seleccionar", 71),
                new FuelEntry(12, "Seleccionar", 72),
                new FuelEntry(13, "Seleccionar", 73),
                new FuelEntry(14, "Seleccionar", 74),

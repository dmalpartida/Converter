...
public class FuelEntry {
    ...
    public static FuelEntry[] populateData() {
        return new FuelEntry[]{
                new FuelEntry(1, "Seleccionar el producto", 5),
                new FuelEntry(2, "Seleccionar la unidad", 32),
                new FuelEntry(3, "Seleccionar la unidad", 33),
                new FuelEntry(4, "Seleccionar la unidad", 34),
                new FuelEntry(5, "Seleccionar la unidad", 35),
                new FuelEntry(6, "Seleccionar la unidad", 66),
                new FuelEntry(7, "Seleccionar la unidad", 67),
                new FuelEntry(8, "Seleccionar la unidad", 68),
                new FuelEntry(9, "Seleccionar la unidad", 69),
                new FuelEntry(10, "Seleccionar la unidad", 70),
                new FuelEntry(11, "Seleccionar la unidad", 71),
                new FuelEntry(12, "Seleccionar la unidad", 72),
                new FuelEntry(13, "Seleccionar la unidad", 73),
                new FuelEntry(14, "Seleccionar la unidad", 74),

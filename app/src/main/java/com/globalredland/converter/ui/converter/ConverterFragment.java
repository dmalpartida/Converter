...
//                ViewModelProviders.of(this).get(ConverterViewModel.class);
    ...
    private void hide_contents(View root){
        ...
        LinearLayout linear_units = root.findViewById(R.id.LinearLayout_units);
        linear_result.setVisibility(View.GONE);
        linear_units.setVisibility(View.GONE);
    }
    private void show_results(View root){
        LinearLayout linear_result = root.findViewById(R.id.linearLayout_Results);
        linear_result.setVisibility(View.VISIBLE);
    }
    private void show_units(View root){
        LinearLayout linear_units = root.findViewById(R.id.LinearLayout_units);
        linear_units.setVisibility(View.VISIBLE);
    }

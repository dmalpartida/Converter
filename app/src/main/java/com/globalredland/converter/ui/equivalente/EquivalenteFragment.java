...
//                imm.toggleSoftInput(InputMethodManager.HIDE_IMPLICIT_ONLY, 0);
    ...
    private void hide_contents(View root){
        LinearLayout linear_result = root.findViewById(R.id.linearLayout_Results);
        LinearLayout linear_units_from = root.findViewById(R.id.LinearLayout_units_from);
        LinearLayout linear_fuel_to = root.findViewById(R.id.LinearLayout_fuel_to);
        LinearLayout linear_units_to = root.findViewById(R.id.LinearLayout_units_to);
        linear_result.setVisibility(View.GONE);
        linear_units_from.setVisibility(View.GONE);
        linear_fuel_to.setVisibility(View.GONE);
        linear_units_to.setVisibility(View.GONE);
    }
    private void show_results(View root){
        LinearLayout linear_result = root.findViewById(R.id.linearLayout_Results);
        linear_result.setVisibility(View.VISIBLE);
    }
    private void show_units_from(View root){
        LinearLayout linear_units_from = root.findViewById(R.id.LinearLayout_units_from);
        linear_units_from.setVisibility(View.VISIBLE);
    }
    private void show_fuels_to(View root){
        LinearLayout linear_fuel_to = root.findViewById(R.id.LinearLayout_fuel_to);
        linear_fuel_to.setVisibility(View.VISIBLE);
    }
    private void show_units_to(View root){
        LinearLayout linear_units_to = root.findViewById(R.id.LinearLayout_units_to);
        linear_units_to.setVisibility(View.VISIBLE);
    }
    private void button_disabled(View root){
        Button button_convert = root.findViewById(R.id.converter_button);
        button_convert.setBackgroundResource(R.drawable.button_shape_disabled);
